...
const sheetVariants = cva(
  "fixed z-50 flex flex-col gap-6 border-sepia/30 bg-parchment p-6 shadow-xl outline-none transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
