...
export function CanvasViewport() {
  ...
  if (!currentPageId) {
    return (
      <div className="flex h-full w-full items-center justify-center bg-[#E8E8E8]">
        <div className="text-center text-[#999999] font-serif">
          <div className="text-lg">Aucune page sélectionnée</div>
  ...
  return (
    <div
      ref={viewportRef}
      className="relative w-full h-full overflow-auto bg-[#E8E8E8]"
      style={{
